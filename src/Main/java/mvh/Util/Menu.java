...
//                int choice;
//                if (inputFlag == 0) {
//                    //Getting the weight and height from the hashmap
...
//
//                    } else {
//                        //Since the first user is female in the file
//                        if (choice == 1) {
...
//            } else {
//                System.err.println("You Didn't Choose any of the option");
//            }
